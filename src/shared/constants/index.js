...
const education = [
    {
        ...
        description:
            "A 4-phase program to learn about developing JavaScript-based app, from backend, web-client, mobile-client. learn multiple kinds of JavaScript tech stack such as React JS, React Native, Vue JS, etc. Developing multiple projects, from mobile to web apps during the course.",
    },
    {
...
const projects = [
        ...
        tech: [
            {
                ...
                description: "React, React Native, Tailwind",
            },
            {
                title: "Backend Stack",
                description:
                    "Apollo, graphql, MongoDB, NodeJS, BcryptJS, dotENV, JWT, SequelizeJs, PostgreSQL, ExpressJS, jest, mongoose",
            },
            {
                title: "Other tech",
                description:
                    " XenditApi, MidtransApi, Docker, googleMapsApi, graphql, Redis, jest, socketIO, mongoDB atlas",
            },
        ],
        link: [
            {
    ...
    },
    {
        ...
        tech: [
            {
                title: "Frontend Stack",
                description: "Vue JS, VueX, Tailwind, Axios",
            },
            {
                title: "Backend Stack",
...
export { main, education, experiences, technologies, projects, contacts };
